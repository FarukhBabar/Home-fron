...
const getUsersList = async() =>{
        let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/userlist")
...
console.log("usres", usersData)
    ...
    const deleteUser = async(id) =>{
        // console.log(id)
     let result = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/deluser/${id}`,{
        method: 'delete'
     })
     result = await result.json()
