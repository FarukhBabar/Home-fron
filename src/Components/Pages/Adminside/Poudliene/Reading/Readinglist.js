...
const Readinglist = () => {
  ...
  return (
    ...
    <div className='container w-75'>
           <h4 className='my-4 text-center text-warning display-4 fw-bold'>List of Reading  Products</h4>
           <Link to="/readingform" ><button className='btn btn-success mb-2 w-10'>+ Add New Product </button></Link>  
                         ...
                         user.map((ele,ind)=>{
                            ...
                            src={`https://homeessential-fdca5e469865.herokuapp.com/${ele.image}`} 
                                    ...
                                    style={{ height: '70px', width: '100px' }}
                                         ...
                                         <td>
                                             <Link to={`/listreading/${ele._id}`} className='btn btn-success'>Edit</Link>
