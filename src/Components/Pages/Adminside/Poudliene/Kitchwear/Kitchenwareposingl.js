...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/kitchenpoundsingle/${params.id}`);
...
const Potoysingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/kitchenpoundsingle');
