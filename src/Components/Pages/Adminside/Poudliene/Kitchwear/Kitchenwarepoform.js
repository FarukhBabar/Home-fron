...
const Kitchenwarepoform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/kitchenpoundproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    <div>
      ...
      <Link to="/listkitchenwearpound" className="btn btn-success mss" >Product-list</Link>
      <form className='marr '>
...
export default Kitchenwarepoform
