...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/candelessingle/${params.id}`);
...
const Candelessingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/candelessingle');
