...
//             try {
//                 const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/shoesingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/shoesingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const Shoeupdate = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/shoesingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
