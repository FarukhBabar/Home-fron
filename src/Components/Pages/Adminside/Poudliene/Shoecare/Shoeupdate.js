...
//             try {
//                 const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/shoesingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/shoesingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const Shoeupdate = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/shoesingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
