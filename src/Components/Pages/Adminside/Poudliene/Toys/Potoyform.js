...
//     }
//     try {
//       let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/potoyproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listpotoy" className="btn btn-success mss" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/potoyproducts', {
                method: 'POST',
                body: formData
            });
