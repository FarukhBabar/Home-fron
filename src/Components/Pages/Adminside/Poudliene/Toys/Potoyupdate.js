...
//             try {
//                 const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/potoysingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/potoysingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const Potoyupdate = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/potoysingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
