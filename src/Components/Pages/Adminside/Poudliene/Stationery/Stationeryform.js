...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/stationproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/liststationery" className="btn btn-success mss" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/stationproducts', {
                method: 'POST',
                body: formData
            });
