...
//             try {
//                 const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/stationsingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/stationsingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const Stationeryupdate = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/stationsingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
