...
const Househldprform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/householdprproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    <div>
      ...
      <Link to="/listhouseholdpr" className="btn btn-success mss" >Product-list</Link>
      <form className='marr '>
