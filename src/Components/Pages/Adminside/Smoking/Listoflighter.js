...
//     let result = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/liguser');
...
//     try {
//       let result = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/lighuserid/${selectedUserId}`, {
//         method: 'DELETE',
//       });
//       result = await result.json();
//       if (result) {
...
const Listoflighter = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/liguser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/lighuserid/${id}`, {
        method: 'DELETE',
      });
