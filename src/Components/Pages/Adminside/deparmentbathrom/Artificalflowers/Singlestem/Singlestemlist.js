...
//         let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/singlestemuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/singlestemuserid/${id}`,{
//             method:"delete"
...
const Singlestemlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/singlestemuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/singlestemuserid/${id}`, {
        method: 'DELETE',
      });
