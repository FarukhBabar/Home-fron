...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/bouquetsingle/${params.id}`);
...
const Bouquetsingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/bouquetsingle');
