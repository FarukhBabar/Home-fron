...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/artificaluser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/artificaluserid/${id}`,{
//             method:"delete"
...
const Artificallist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://api.homeessentialshive.co.uk/api/v1/data/artificaluser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/artificaluserid/${id}`, {
        method: 'DELETE',
      });
