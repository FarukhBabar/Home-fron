...
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/artificalproducts", {
//         method: "POST",
//         body: formData,
//       });
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/artificalproducts', {
                method: 'POST',
                body: formData
            });
