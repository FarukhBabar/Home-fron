...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/camerasingle/${params.id}`);
...
const Camerasingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/camerasingle');
