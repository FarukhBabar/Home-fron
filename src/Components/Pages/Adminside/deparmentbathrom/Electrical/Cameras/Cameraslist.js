...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/camerauser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/camerauserid/${id}`,{
//             method:"delete"
...
const Cameraslist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/camerauser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/camerauserid/${id}`, {
        method: 'DELETE',
      });
