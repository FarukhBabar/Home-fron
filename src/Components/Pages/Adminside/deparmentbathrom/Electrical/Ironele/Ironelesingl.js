...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/ironelesingle/${params.id}`);
...
const Ironelesingle = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/ironelesingle');
