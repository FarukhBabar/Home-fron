...
//     }
//     try {
//       let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/eleaccessoriesproducts" , {
//         method: "post",
//         body :formdata
...
//       if(result){
//         nevigate("/listelectricalaccesso")
...
//       <Link to="/listelectricalaccesso" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default ElectricalAccessform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/eleaccessoriesproducts', {
                method: 'POST',
                body: formData
            });
            ...
            if (result) {
                ...
                navigate('/listelectricalaccesso')
