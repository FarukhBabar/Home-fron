...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/eleaccessoriessingle/${params.id}`);
...
const ElectricalAccesssingle = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/eleaccessoriessingle');
