...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/eleaccessoriessingle/${params.id}`);
...
const ElectricalAccesssingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/eleaccessoriessingle');
