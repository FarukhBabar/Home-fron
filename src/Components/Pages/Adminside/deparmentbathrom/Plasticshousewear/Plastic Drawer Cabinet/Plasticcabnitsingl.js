...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/plasticcabnitsingle/${params.id}`);
...
const Plasticcabnitsingl = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/plasticcabnitsingle');
