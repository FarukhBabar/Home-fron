...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/plasticcabnitproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listplasticcabnit" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Plasticcabnitform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/plasticcabnitproducts', {
                method: 'POST',
                body: formData
            });
