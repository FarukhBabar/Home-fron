...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/plasticcabnituser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/plasticcabnituserid/${id}`,{
//             method:"delete"
...
const Plasticcabnitlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/plasticcabnituser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/plasticcabnituserid/${id}`, {
        method: 'DELETE',
      });
