...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/plasticcabnituser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/plasticcabnituserid/${id}`,{
//             method:"delete"
