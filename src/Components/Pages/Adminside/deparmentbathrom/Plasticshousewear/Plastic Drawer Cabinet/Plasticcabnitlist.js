...
//         let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/plasticcabnituser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/plasticcabnituserid/${id}`,{
//             method:"delete"
...
//            <Link to="/plasticcabnitform" ><button className='btn btn-success mb-2 w-10'>+ Add New Product </button></Link>  
...
//                                )}</td>
//                                          <td>
//                                              <Link to={`/listplasticcabnit/${ele._id}`} className='btn btn-success'>Edit</Link>
...
const Plasticcabnitlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/plasticcabnituser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/plasticcabnituserid/${id}`, {
        method: 'DELETE',
      });
