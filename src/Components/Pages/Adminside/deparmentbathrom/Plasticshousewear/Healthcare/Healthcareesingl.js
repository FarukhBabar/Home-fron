...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/healthcareesingle/${params.id}`);
...
const Healthcareesingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/healthcareesingle');
export default Healthcareesingl;