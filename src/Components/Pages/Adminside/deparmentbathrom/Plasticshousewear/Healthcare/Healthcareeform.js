...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/healthcareeproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listhealthcaree" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Healthcareeform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/healthcareeproducts", {
                method: 'POST',
                body: formData
            });
