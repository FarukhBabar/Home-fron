...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/melaminproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listmelmanioutdoor" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default MelamineOutdoorform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/melaminproducts', {
                method: 'POST',
                body: formData
            });
