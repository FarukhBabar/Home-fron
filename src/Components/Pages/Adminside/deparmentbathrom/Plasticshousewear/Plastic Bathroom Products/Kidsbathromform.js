...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/plasticbathroomproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listkidsbathroom" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Kidsbathromform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/plasticbathroomproducts', {
                method: 'POST',
                body: formData
            });
