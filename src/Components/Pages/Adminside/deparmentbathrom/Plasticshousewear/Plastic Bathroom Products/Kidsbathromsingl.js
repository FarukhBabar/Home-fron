...
//     try {
//       const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/plasticbathroomsingle/${params.id}`);
...
const Kidsbathromsingl = withDataFetching(SinglePage, 'https://api.homeessentialshive.co.uk/api/v1/data/plasticbathroomsingle');
