...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/kidsplasuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/kidsplasuserid/${id}`,{
//             method:"delete"
