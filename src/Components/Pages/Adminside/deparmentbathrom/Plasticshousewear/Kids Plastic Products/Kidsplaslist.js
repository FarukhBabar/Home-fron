...
//         let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/kidsplasuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/kidsplasuserid/${id}`,{
//             method:"delete"
...
const Kidsplaslist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/kidsplasuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/kidsplasuserid/${id}`, {
        method: 'DELETE',
      });
