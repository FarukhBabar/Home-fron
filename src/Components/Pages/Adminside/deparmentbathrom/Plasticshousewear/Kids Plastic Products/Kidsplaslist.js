...
const Kidsplaslist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/kidsplasuser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/kidsplasuserid/${id}`,{
            method:"delete"
