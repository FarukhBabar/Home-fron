...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/artcraftuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/artcraftuserid/${id}`,{
//             method:"delete"
