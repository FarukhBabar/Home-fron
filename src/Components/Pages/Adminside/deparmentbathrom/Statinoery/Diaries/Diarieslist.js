...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/diariesuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/diariesuserid/${id}`,{
//             method:"delete"
...
const Diarieslist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/diariesuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/diariesuserid/${id}`, {
        method: 'DELETE',
      });
