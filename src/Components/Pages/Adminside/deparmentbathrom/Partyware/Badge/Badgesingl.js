...
//     try {
//       const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/Obsticalsingle/${params.id}`);
...
const Badgesigle = withDataFetching(SinglePage, 'https://api.homeessentialshive.co.uk/api/v1/data/Obsticalsingle');
