...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/bannerproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listbanner" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Partyaccessoriesform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/pumpsproducts', {
                method: 'POST',
                body: formData
            });
