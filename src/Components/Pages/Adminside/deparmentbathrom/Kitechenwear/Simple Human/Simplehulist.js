...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/simplehumanuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/simplehumanuserid/${id}`,{
//             method:"delete"
