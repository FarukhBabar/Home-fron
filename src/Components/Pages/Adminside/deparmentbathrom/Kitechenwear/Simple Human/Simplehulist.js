...
const Simplehulist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/simplehumanuser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/simplehumanuserid/${id}`,{
            method:"delete"
