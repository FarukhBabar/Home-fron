...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/simplehumanuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/simplehumanuserid/${id}`,{
//             method:"delete"
...
const Simplehulist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/simplehumanuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/simplehumanuserid/${id}`, {
        method: 'DELETE',
      });
