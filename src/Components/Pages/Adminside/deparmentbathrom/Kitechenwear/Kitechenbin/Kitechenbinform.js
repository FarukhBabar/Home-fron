...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/kitechenbinproducts" , {
//         method: "post",
//         body :formdata
...
// export default Kitechenbinform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/kitechenbinproducts', {
                method: 'POST',
                body: formData
            });
