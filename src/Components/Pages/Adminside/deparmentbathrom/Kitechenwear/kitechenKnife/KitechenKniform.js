...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/kitechenkniproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listkitechenkni" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default KitechenKniform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/kitechenkniproducts"', {
                method: 'POST',
                body: formData
            });
