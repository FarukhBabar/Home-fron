...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/kitechenknisingle/${params.id}`);
...
const KitechenKnisingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/kitechenknisingle');
