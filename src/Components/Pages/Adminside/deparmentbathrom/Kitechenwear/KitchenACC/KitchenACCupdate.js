...
//             try {
//                 const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/kitechenaccsingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/kitechenaccsingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
// export default KitchenACCupdate;
import React, { useState, useEffect } from 'react';
...
const KitchenACCupdate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/kitechenaccsingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
