...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/trayproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listtray" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/trayproducts', {
                method: 'POST',
                body: formData
            });
