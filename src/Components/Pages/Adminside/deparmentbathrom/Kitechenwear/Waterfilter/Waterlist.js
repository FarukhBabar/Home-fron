...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/wateruser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/wateruserid/${id}`,{
//             method:"delete"
