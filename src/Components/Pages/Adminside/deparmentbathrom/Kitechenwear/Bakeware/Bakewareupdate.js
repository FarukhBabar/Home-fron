...
//             try {
//                 const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/bakewaresingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/bakewaresingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const Bakewareupdate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/bakewaresingle/
                ${params.id}`, {
                method: "PUT",
                body: formData
            });
