...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/breadsingle/${params.id}`);
...
const Breadsingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/breadsingle');
