...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/scaleproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listscalekitechen" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/scaleproducts', {
                method: 'POST',
                body: formData
            });
