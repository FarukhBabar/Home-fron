...
//   useEffect(() => {
//     axios.get("https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/plastickitechenfreedelivery")
...
const Plasticki = () => {
  ...
  return (
    <div className="container mt-1">
      <div className="row">
        {users.map(user => (
          <CardNew key={user._id} user={user} baseUrl="/plastickitechensinglepage" />
        ))}
      </div>
    </div>
  );
