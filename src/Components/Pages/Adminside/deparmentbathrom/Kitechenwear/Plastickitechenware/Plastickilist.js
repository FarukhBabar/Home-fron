...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/plastickitechenuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/plastickitechenuserid/${id}`,{
//             method:"delete"
