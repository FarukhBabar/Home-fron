...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/kitechengasingle/${params.id}`);
...
const Kitechengasingl = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/kitechengasingle');
