...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/frammirrorproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listframsmirror" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Framsmirrorform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/frammirrorproducts', {
                method: 'POST',
                body: formData
            });
