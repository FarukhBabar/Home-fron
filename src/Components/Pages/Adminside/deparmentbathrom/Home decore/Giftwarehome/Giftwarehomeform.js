...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/giftwarehproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listgiftwareh" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Giftwarehomeform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/giftwarehproducts', {
                method: 'POST',
                body: formData
            });
