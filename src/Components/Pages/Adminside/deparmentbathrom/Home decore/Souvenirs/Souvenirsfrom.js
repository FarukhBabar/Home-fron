...
//     }
//     try {
//       let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/auth/souvenirsproducts" , {
//         method: "post",
//         body :formdata
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/auth/souvenirsproducts', {
                method: 'POST',
                body: formData
            });
