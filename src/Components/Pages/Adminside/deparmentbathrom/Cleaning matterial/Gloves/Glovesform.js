...
//     }
//     try {
//       let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/auth/glovesproducts" , {
//         method: "post",
//         body :formdata
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/auth/glovesproducts', {
                method: 'POST',
                body: formData
            });
