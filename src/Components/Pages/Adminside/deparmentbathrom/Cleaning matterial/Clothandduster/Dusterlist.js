...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/dusteruser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/dusteruserid/${id}`,{
//             method:"delete"
