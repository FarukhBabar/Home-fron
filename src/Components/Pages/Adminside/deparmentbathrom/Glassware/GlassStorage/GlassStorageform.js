...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth//glassstoragesproducts" , {
//         method: "post",
//         body :formdata
...
// export default GlassStorageform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth//glassstoragesproducts', {
                method: 'POST',
                body: formData
            });
