...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/klineruser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/klineruserid/${id}`,{
//             method:"delete"
