...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/crystalsingle/${params.id}`);
...
const Crystalsingl = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/crystalsingle');
