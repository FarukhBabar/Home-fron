...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/glassdecorativeuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/glassdecorativeuserid/${id}`,{
//             method:"delete"
...
const GlassDecorativelist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/glassdecorativeuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/glassdecorativeuserid/${id}`, {
        method: 'DELETE',
      });
