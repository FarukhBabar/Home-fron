...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/glassdecorativeproducts" , {
//         method: "post",
//         body :formdata
...
// export default GlassDecorativeform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/glassdecorativeproducts', {
                method: 'POST',
                body: formData
            });
