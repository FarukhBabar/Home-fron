...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/catuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/catuserid/${id}`,{
//             method:"delete"
...
//            <Link to="/catform" ><button className='btn btn-success mb-2 w-10'>+ Add New Product </button></Link>  
...
//                                )}</td>
//                                          <td>
//                                              <Link to={`/listcat/${ele._id}`} className='btn btn-success'>Edit</Link>
...
const Catlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/catuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/catuserid/${id}`, {
        method: 'DELETE',
      });
