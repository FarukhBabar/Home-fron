...
//         let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/catuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/catuserid/${id}`,{
//             method:"delete"
...
const Catlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/catuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/catuserid/${id}`, {
        method: 'DELETE',
      });
