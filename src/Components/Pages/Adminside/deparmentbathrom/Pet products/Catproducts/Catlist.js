...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/catuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/catuserid/${id}`,{
//             method:"delete"
