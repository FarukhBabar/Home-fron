...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/birdssingle/${params.id}`);
...
const Birdssingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/birdssingle');
