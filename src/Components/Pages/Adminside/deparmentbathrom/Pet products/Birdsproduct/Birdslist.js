...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/birdsuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/birdsuserid/${id}`,{
//             method:"delete"
...
const Birdslist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/birdsuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/birdsuserid/${id}`, {
        method: 'DELETE',
      });
