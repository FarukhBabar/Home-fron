...
//     try {
//       let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/drinkingglassproducts", {
//         method: "POST",
//         body: formData,
//       });
//       result = await result.json();
//       if (result) {
//         navigate("/listdrinkingglass");
...
//   return (
//     <div>
//       <Link to="/listdrinkingglass" className="btn btn-success mss mt-2">Product-list</Link>
//       <form className='marr'>
...
// export default DrinkingGlassform;
