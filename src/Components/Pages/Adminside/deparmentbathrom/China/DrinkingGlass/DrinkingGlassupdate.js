...
//             try {
//                 const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/drinkingglasssingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/drinkingglasssingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
// export default DrinkingGlassupdate;
...
const DrinkingGlassupdate = () => {
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/drinkingglasssingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
