...
//         let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/drinkingglassuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/drinkingglassuserid/${id}`,{
//             method:"delete"
...
const DrinkingGlasslist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/drinkingglassuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/drinkingglassuserid/${id}`, {
        method: 'DELETE',
      });
