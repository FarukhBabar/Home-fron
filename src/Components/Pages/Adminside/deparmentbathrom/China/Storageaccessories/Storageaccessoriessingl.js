...
// const Storageaccessoriessingel = () => {
...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/storageaccesssingle/${params.id}`);
...
const Storageaccessoriessingel = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/storageaccesssingle');
