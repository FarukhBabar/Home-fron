...
//             try {
//                 const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/homebakingsingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/homebakingsingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const HomeBakingupdate = () => {
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/homebakingsingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
