...
//             try {
//                 const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/homebakingsingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/homebakingsingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
// export default HomeBakingupdate;
...
const HomeBakingupdate = () => {
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/homebakingsingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
