...
//             try {
//                 const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/homebakingsingle/${params.id}`);
...
//                 try {
//                     let result = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/homebakingsingle/${params.id}` , {
//         method: "put",
//         body :formdata
...
const HomeBakingupdate = () => {
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/homebakingsingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
