...
const GlassTablewearupdate = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/glasstablewaersingle/${params.id}`);
    ...
    const updateUser = async (e) => {
        ...
        try {
            let response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/glasstablewaersingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
...
export default GlassTablewearupdate;
