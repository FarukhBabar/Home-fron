...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/glasstablewaersingle/${params.id}`);
...
// export default GlassTablewearsingel;


import withDataFetching from '../../../../../withDataFetching';
import SinglePage from '../../../../../SinglePage';

const GlassTablewearsingel = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/glasstablewaersingle');
