...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/Ironingproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listlaacess" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/Loundryproducts', {
                method: 'POST',
                body: formData
            });
