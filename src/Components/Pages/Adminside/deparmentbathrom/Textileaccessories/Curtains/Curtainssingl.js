...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/curtainssingle/${params.id}`);
...
const Curtainssingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/curtainssingle');
