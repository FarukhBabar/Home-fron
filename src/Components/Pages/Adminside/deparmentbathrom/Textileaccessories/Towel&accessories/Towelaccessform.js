...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/towelaccessoriesproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listtowelaccessories" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
// export default Towelaccessform;
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://api.homeessentialshive.co.uk/api/v1/auth/towelaccessoriesproducts', {
                method: 'POST',
                body: formData
            });
