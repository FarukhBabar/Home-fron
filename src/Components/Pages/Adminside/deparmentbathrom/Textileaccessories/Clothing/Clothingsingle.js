...
//     try {
//       const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/Clothingsingle/${params.id}`);
...
const Clothingsingle = withDataFetching(SinglePage, 'https://api.homeessentialshive.co.uk/api/v1/data/Clothingsingle');
