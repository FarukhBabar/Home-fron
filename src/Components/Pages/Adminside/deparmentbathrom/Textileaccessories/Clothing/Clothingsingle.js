...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/Clothingsingle/${params.id}`);
...
const Clothingsingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/Clothingsingle');
