...
const Wernerlist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/werneruser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/werneruserid/${id}`,{
            method:"delete"
