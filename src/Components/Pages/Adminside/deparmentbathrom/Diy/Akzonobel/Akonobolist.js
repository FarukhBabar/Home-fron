...
const Akonobolist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/Akonoboluser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/Akonoboluserid/${id}`,{
            method:"delete"
