...
const Locktileform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/auth/locktileproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    ...
    <div>
      ...
      <Link to="/listlocktile" className="btn btn-success mss mt-2" >Product-list</Link>
      <form className='marr '>
