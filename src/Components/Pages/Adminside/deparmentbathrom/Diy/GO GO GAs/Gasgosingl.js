...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/gassyssingle/${params.id}`);
...
const Gasgosingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/gassyssingle');
