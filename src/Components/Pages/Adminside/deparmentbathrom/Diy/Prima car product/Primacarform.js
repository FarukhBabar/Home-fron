...
const Primacarform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/primacarproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    ...
    <div>
      ...
      <Link to="/listprimacar" className="btn btn-success mss mt-2" >Product-list</Link>
      <form className='marr '>
