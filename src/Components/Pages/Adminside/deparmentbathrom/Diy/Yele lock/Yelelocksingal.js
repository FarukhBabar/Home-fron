...
//     try {
//       const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/yelelocksingle/${params.id}`);
...
const Yelelocksingl = withDataFetching(SinglePage, 'https://api.homeessentialshive.co.uk/api/v1/data/yelelocksingle');
