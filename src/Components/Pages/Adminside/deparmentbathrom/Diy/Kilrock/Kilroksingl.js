...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/kilrocksingle/${params.id}`);
...
const Kilroksingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/kilrocksingle');
