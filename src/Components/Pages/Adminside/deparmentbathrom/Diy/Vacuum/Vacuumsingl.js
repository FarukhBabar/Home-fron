...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/vacuumsingle/${params.id}`);
...
const Ultratrapesingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/vacuumsingle');
