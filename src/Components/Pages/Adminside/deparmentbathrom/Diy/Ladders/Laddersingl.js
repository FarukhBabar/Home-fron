...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/laddersingle/${params.id}`);
...
const Laddersingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/laddersingle');
