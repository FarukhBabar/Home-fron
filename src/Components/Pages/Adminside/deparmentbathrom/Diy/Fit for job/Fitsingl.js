...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/fitsingle/${params.id}`);
...
const Fitsingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/fitsingle');
