...
const Antiquxform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/antiquxproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    ...
    <div>
      ...
      <Link to="/listantiqux" className="btn btn-success mss mt-2" >Product-list</Link>
      <form className='marr '>
