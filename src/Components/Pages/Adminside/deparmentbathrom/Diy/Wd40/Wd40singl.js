...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/wd40single/${params.id}`);
...
const Wd40singl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/wd40single');
