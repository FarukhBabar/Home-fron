...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/hagsensingle/${params.id}`);
...
const Hagesansingl = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/hagsensingle');
