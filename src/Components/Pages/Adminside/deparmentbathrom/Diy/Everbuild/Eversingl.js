...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/eversingle/${params.id}`);
...
const Eversingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/eversingle');
