...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/Freshnersingle/${params.id}`);
...
const Freshnersingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/Freshnersingle');
