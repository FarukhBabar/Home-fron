...
const Gorilaform = () => {
  ...
  const [nameError, setNameError] = useState(false);
    ...
    try {
      let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/auth/gorilaproducts" , {
        method: "post",
        body :formdata
  ...
  return (
    ...
    <div>
      ...
      <Link to="/listgorila" className="btn btn-success mss mt-2" >Product-list</Link>
      <form className='marr '>
