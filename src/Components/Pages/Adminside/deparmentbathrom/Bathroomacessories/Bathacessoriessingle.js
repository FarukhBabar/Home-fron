...
//     try {
//       const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/bathacesssingle/${params.id}`);
...
const Bathacessoriessingle = withDataFetching(SinglePage, 'https://api.homeessentialshive.co.uk/api/v1/data/bathacesssingle');
