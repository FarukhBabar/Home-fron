...
//     }
//     try {
//       let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/auth/handproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listhand" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
