...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/sanitarysingle/${params.id}`);
...
const Sanitarysingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8001/api/v1/data/sanitarysingle');
