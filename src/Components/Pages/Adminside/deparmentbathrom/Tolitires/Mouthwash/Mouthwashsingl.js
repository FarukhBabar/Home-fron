...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/mouthsingle/${params.id}`);
...
const Mouthwashsingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/mouthsingle');
