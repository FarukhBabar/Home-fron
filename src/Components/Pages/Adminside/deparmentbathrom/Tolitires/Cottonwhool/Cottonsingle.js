...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/cottonsingle/${params.id}`);
...
const Cottonsingle = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/cottonsingle');
