...
//     }
//     try {
//       let result = await fetch("https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/giftwareproducts" , {
//         method: "post",
//         body :formdata
...
//       <Link to="/listgiftware" className="btn btn-success mss mt-2" >Product-list</Link>
//       <form className='marr '>
...
const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch('https://homeessential-fdca5e469865.herokuapp.com/api/v1/auth/giftwareproducts', {
                method: 'POST',
                body: formData
            });
