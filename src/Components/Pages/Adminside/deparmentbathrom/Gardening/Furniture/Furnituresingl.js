...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/furnitursingle/${params.id}`);
...
const Furniturlist = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/data/furnitursingle');
