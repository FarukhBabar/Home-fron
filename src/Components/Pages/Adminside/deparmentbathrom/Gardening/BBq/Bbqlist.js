...
//         let result = await fetch("https://api.homeessentialshive.co.uk/api/v1/data/bbquser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`https://api.homeessentialshive.co.uk/api/v1/data/bbquserid/${id}`,{
//             method:"delete"
