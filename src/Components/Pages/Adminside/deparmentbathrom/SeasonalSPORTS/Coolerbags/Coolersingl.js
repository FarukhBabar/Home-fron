...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/sportsingle/${params.id}`);
...
const Coolersingl = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/api/v1/data/sportsingle');
