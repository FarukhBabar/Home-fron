...
//         let result = await fetch("http://srv577826.hstgr.cloud:8002/api/v1/data/sportuser")
...
//           // console.log(id)
//           try {
//               let result= await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/sportuserid/${id}`,{
//             method:"delete"
...
const Coolerlist = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8002/api/v1/data/sportuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/data/sportuserid/${id}`, {
        method: 'DELETE',
      });
