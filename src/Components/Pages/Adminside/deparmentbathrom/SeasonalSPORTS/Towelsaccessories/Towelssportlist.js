...
const Towelssportlist = () => {
    ...
    const setUsersData = async() =>{
        let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/umbrellauser")
      ...
      const deleteuser = async(id)=>{
          // console.log(id)
          try {
              let result= await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/umbrellauserid/${id}`,{
            method:"delete"
