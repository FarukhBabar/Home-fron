...
//             try {
//                 const response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/umbrella2single/${params.id}`);
...
//         try {
//             let response = await fetch(`http://srv577826.hstgr.cloud:8002/api/v1/auth/umbrella2single/${params.id}`, {
//                 method: "PUT",
//                 body: formData
//             });
...
const Umbrellaupdate = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/api/v1/auth/umbrella2single');
