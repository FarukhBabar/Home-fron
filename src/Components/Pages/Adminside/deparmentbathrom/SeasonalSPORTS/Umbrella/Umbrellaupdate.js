...
//             try {
//                 const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/umbrella2single/${params.id}`);
...
//         try {
//             let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/umbrella2single/${params.id}`, {
//                 method: "PUT",
//                 body: formData
//             });
