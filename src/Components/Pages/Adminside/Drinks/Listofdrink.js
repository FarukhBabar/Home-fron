...
//         try {
//             let result = await fetch("http://srv577826.hstgr.cloud:8001/api/v1/data/driuser");
...
//         try {
//             let result = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/driuserid/${id}`, {
//                 method: "DELETE"
//             });
//             result = await result.json();
//             if (result) {
...
const Listofdrink = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('http://srv577826.hstgr.cloud:8001/api/v1/data/driuser');
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/data/driuserid/${id}`, {
        method: 'DELETE',
      });
