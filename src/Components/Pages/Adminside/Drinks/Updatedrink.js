...
//             try {
//                 const response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/drisingle/${params.id}`);
...
//         try {
//             let result = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/drisingle/${params.id}`, {
//                 method: "PUT",
//                 body: formData
//             });
...
const Updateelectrical = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`http://srv577826.hstgr.cloud:8001/api/v1/auth/drisingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
