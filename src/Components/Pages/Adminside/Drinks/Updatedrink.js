...
//             try {
//                 const response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/drisingle/${params.id}`);
...
//         try {
//             let result = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/drisingle/${params.id}`, {
//                 method: "PUT",
//                 body: formData
//             });
...
const Updateelectrical = () => {
   const [name, setName] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await fetch(`https://api.homeessentialshive.co.uk/api/v1/auth/drisingle/${params.id}`, {
                method: "PUT",
                body: formData
            });
