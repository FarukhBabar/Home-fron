...
//     try {
//       const response = await fetch(`http://srv577826.hstgr.cloud:8002/smokingsingalepage/${params.id}`);
...
const Smokingsinglepage = withDataFetching(SinglePage, 'http://srv577826.hstgr.cloud:8002/smokingsingalepage');
