...
//     try {
//       const response = await fetch(`https://homeessential-fdca5e469865.herokuapp.com/smokingsingalepage/${params.id}`);
...
const Smokingsinglepage = withDataFetching(SinglePage, 'https://homeessential-fdca5e469865.herokuapp.com/smokingsingalepage');
