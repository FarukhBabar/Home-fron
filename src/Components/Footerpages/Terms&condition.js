...
const Termscondition = () => {
  ...
  <div className="row">
    <div className="col-lg-12 col-md-12 col-sm-12">
      ...
      <p>
        The company stands for Home Essentials Hive, the customer stands for purchaser, and the contract stands for an agreement between the company and the customer. 
“The contract shall stand to following conditions which the customer will have to accept or agree to in writing. 
...
The contract shall be conditioned according to English law. 
      ...
      <b>
        <p> The product cost.</p>
      </b>
      <p>" The cost of the product shall be applicable at the rates on the dispatch date except when the quotation is given prior. The customer shall be responsible for paying any duties or taxes that are imposed on goods 
      ...
      <p>
        No order shall be delivered, nor shall it be kept stored for the customer unless full payment is made. The company will also authorize payments made through debit or credit cards. If the customer fails to pay the price, the company will suspend all further deliveries unless he clears all the previous payments. If packages are returned in improper condition, the customer has to pay for them. The company will provide a replacement product similar to that product.  </p>
      <b>
        <p>TRANSFER OF PROPERTY AND RISKS</p>
      </b>
      ...
      <b>
        <p>Suspension and late IN PRODUCT  DELIVERY</p>
      </b>
      <p>The company will not be responsible for the delay in delivery due to the following reasons 
·         Cause below the company’s access; <br/>
·         If any person, whether a company’s employee or any other person, takes industrial action;<br/>
·         Accident, injury or casualty of any person;<br/>
·         Fault in any machinery, tool or   vehicle;<br/>
      ...
      <br /><br />
      <b>
        <p> Complains against product issues </p>
      </b>
      <p>
