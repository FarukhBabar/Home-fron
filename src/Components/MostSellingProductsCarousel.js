...
//    const Formatename = product.name.replace(/\s+/g, '-').replace(/[^a-zA-Z0-9-]/g, '').toLowerCase();
//     navigate(`/product/${productName}`, { state: { id: user._id } });
// };
...
//               <img src={`https://homeessential-fdca5e469865.herokuapp.com/${product.image.replace(/\\/g, '/')}`} className="card-img-top" alt={product.name} />
